...
const habitLogSchema = new mongoose.Schema(
  {
    ...
    diet: {
      mealType: {
        type: String,
        enum: ["vegan", "vegetarian", "mixed", "meat_heavy"],
      },
    ...
    exercise: {
      ...
      type: {
        type: String,
        enum: ["walk", "run", "gym", "yoga", "sport", "other"],
      },
    ...
    // ── Checklist state ───────────────────────────────────────────────────
    checklist: {
      "Sleep (6–9h)": { type: Boolean, default: false },
      "Healthy Meal": { type: Boolean, default: false },
      "Exercise (30 min)": { type: Boolean, default: false },
      "Screen Time < 4h": { type: Boolean, default: false },
      "Water (8 glasses)": { type: Boolean, default: false },
    },
