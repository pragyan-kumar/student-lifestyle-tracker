...
class _WalletTab extends StatelessWidget {
  ...
  static const _history = [
    ('7-Day Sleep Streak 🏆', '+50 pts', '18 Aug'),
    ('Logged vegetarian meal 🥗', '+10 pts', '18 Aug'),
    ('Metro commute 🚇', '+20 pts', '17 Aug'),
    ('30 min run 🏃', '+15 pts', '17 Aug'),
    ('Streak Freeze used ❄️', '-30 pts', '16 Aug'),
  ];
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Text('1,240', style: theme.textTheme.displayLarge?.copyWith(color: Colors.white, fontWeight: FontWeight.w800)),
...
class _BadgesTab extends StatelessWidget {
  ...
  static const _badges = [
    ('🌱', 'Eco Starter',    'Logged first zero-emission commute',       true),
    ('🔥', '7-Day Streak',   'Completed all habits for 7 days straight', true),
    ('🚇', 'Metro Hero',     'Used metro 10 times',                      true),
    ('🥗', 'Green Eater',    'Logged 5 vegetarian days',                 true),
...
class _RedeemTab extends StatelessWidget {
  ...
  static const _rewards = [
    ('❄️', 'Streak Freeze',   'Skip one day without losing your streak',  30,  true),
    ('🎨', 'Dark Neon Theme', 'Unlock an exclusive neon app theme',        200, true),
